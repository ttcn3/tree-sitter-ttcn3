LANGUAGE_NAME := tree-sitter-ttcn3
HOMEPAGE_URL := https://github.com/ttcn3/tree-sitter-ttcn3
VERSION := 0.2.1
DESCRIPTION := TTCN-3 grammar for tree-sitter
...
install: all
	install -d '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/ttcn3 '$(DESTDIR)$(INCLUDEDIR)'/tree_sitter '$(DESTDIR)$(PCLIBDIR)' '$(DESTDIR)$(LIBDIR)'
...
ifneq ($(wildcard queries/*.scm),)
	install -m644 queries/*.scm '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/ttcn3
endif
...
uninstall:
	...
	$(RM) -r '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/ttcn3
